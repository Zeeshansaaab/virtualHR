                        ...
                        <ul class="nk-menu nk-menu-main">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="/demo2/ecommerce/index.html" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">eCommerce Panel</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/demo3/apps/file-manager.html" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">File Manangement Panel</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/demo4/subscription/index.html" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Subscription Panel</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/demo5/crypto/index.html" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Crypto Buy Sell Panel</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/demo6/invest/index.html" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">HYIP Investment Panel</span></a>
                                    </li>
                                </ul><!-- .nk-menu-sub -->
                            </li><!-- .nk-menu-item -->
                        </ul>
                ...
                <div class="nk-header-tools">
                    <ul class="nk-quick-nav">
                        <li class="dropdown hide-mb-sm">
                            <Link :href="route('login')" data-toggle="modal" data-target="#region" class="nk-quick-nav-icon"><em class="icon ni ni-globe"></em></Link>
                        </li>
                        ...
                        <li class="dropdown user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                ...
                                <div class="dropdown-inner">
                                    <ul class="link-list">
                                        <li><Link as="button" :href="route('logout')" method="POST">
